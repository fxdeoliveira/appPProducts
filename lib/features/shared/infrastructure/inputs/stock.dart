...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.value) return 'Tiene que ser un numero 0 o mayor';
    if (displayError == StockError.format) return 'No tiene formato corecto';
  ...
  StockError? validator(int value) {
    ...
    if(value.toString().contains('..')) return StockError.value;
